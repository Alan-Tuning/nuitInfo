...
const handleCloudSelection = (id) => {
    ...
    currentComponent.value = QuizPage;
  }
...
<template>
  ...
  <!-- Display the StoryPopup when show_story_popup is true -->
  <StoryPopup :message="story_message" :show-footer="show_story_popup" @close_popup="show_story_popup = false" />
</template>
